...
//Cho phép hiển thị lỗi SQL dạng die() thay vì exception
...
// Hiển thị lỗi SQL ra trình duyệt
if (!$result) {
    ...
    <div class="w-full max-w-[1200px] mx-auto px-6">
        ...
        <div class="flex flex-col lg:flex-row gap-6 lg:gap-10 items-start">
            ...
            <div class="w-full lg:max-w-xl">
                ...
                <p class="text-red-600 text-xl font-semibold mb-3"><?= is_numeric($product['price']) ? number_format($product['price'], 0, ',', '.') : $product['price'] ?>₫</p>
                <!--Chọn màu sắc-->
                <div class="mb-3">
